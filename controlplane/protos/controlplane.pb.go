...
var file_protos_controlplane_proto_rawDesc = []byte{
	...
	0x6d, 0x69, 0x74, 0x65, 0x72, 0x52, 0x07, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x65, 0x72, 0x22, 0xf5,
	...
	0xd2, 0x01, 0x0a, 0x07, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x75,
...
var file_protos_controlplane_proto_depIdxs = []int32{
	...
	3,  // 16: Schema.type:type_name -> Schema.Type
	46, // 17: Schema.schema:type_name -> google.protobuf.Any
	17, // 18: Sampler.schema:type_name -> Schema
	15, // 19: Sampler.config:type_name -> SamplerConfig
	16, // 20: Sampler.sampling_stats:type_name -> SamplerSamplingStats
	47, // 21: SamplerToServer.timestamp:type_name -> google.protobuf.Timestamp
	23, // 22: SamplerToServer.sampler_stats_msg:type_name -> SamplerStatsMsg
	24, // 23: SamplerToServer.register_req:type_name -> SamplerRegisterReq
	27, // 24: SamplerToServer.conf_res:type_name -> ServerSamplerConfRes
	47, // 25: ServerToSampler.timestamp:type_name -> google.protobuf.Timestamp
	25, // 26: ServerToSampler.register_res:type_name -> SamplerRegisterRes
	26, // 27: ServerToSampler.conf_req:type_name -> ServerSamplerConfReq
	47, // 28: ClientToServer.timestamp:type_name -> google.protobuf.Timestamp
	30, // 29: ClientToServer.register_req:type_name -> ClientRegisterReq
	32, // 30: ClientToServer.list_samplers_req:type_name -> ClientListSamplersReq
	38, // 31: ClientToServer.sampler_conf_req:type_name -> ClientSamplerConfReq
	47, // 32: ServerToClient.timestamp:type_name -> google.protobuf.Timestamp
	29, // 33: ServerToClient.sampler_stats_msg:type_name -> ClientSamplerStatsMsg
	31, // 34: ServerToClient.register_res:type_name -> ClientRegisterRes
